...
const formSchema = updateFormSchema.pick({ professionalTitle: true });
type FormData = z.infer<typeof formSchema>;

export default function ProfessionalTitleSection({ data }: { data: FormData }) {
