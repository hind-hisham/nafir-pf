...
// }
  ...
  return (
    ...
    <div className="grid w-full items-center gap-1.5">
      ...
      <Input type="password" value={password} onChange={(e) => setPassword(e.target.value)} id="email" placeholder="Email" />
    </div>

          <Button onClick={handleSubmit}  type="submit" size={"lg"} className="mt-4">
         login
          </Button>
